...
export const APIHomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>
          RegTech API Documentation | Reguard
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content={`RegTech API Documentation`}
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://reguard.com/apis/`}
        />
      </Helmet>
      <Header />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl">
            ...
            <p className="font-inter text-xl text-white/90 mb-8 leading-relaxed">
              Explore our collection of powerful, reliable, and production-ready APIs. 
              Designed for developers, startups, and enterprises, our APIs help you build, 
              scale, and innovate with ease — all with guaranteed uptime, fast response 
              times, and seamless integration.
            </p>
