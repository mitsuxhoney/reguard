...
export const APIHomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>RegTech API Documentation | Reguard</title>
        <meta
          name="description"
          content={`Explore powerful APIs with comprehensive documentation, code examples, and enterprise-grade security.`}
        />
        <meta
          name="keywords"
          content={`RegTech APIs, financial services APIs, compliance automation, regulatory technology, API documentation, enterprise APIs, fintech solutions, banking APIs, compliance`}
        />
        <link rel="canonical" href={`https://reguard.com/apis`} />
        <meta property="og:title" content={`RegTech API Documentation`} />
        <meta
          property="og:description"
          content={`Powerful APIs for regulatory compliance and identity verification.`}
        />
        <meta property="og:url" content={`https://reguard.com/apis/`} />
      </Helmet>
      <Header />
      ...
      {/* Hero Section */}
      <section
        className={`bg-gradient-to-br  from-gray-900 via-gray-800 to-red-900 text-white py-16`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <h1 className="font-gilroy text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Your gateway to reliable and scalable APIs.
            </h1>
            <p className="font-inter text-xl text-white/90 mb-8 leading-relaxed">
              Explore our collection of powerful, reliable, and production-ready
              APIs. Designed for developers, startups, and enterprises, our APIs
              help you build, scale, and innovate with ease — all with
              guaranteed uptime, fast response times, and seamless integration.
            </p>
